...
@section('content')
    ...
    <section class="section">
        ...
        <div class="section-body">
            <h2 class="section-title">Tambah Data Periode</h2>

            <div class="card">
                <div class="card-header">
                    <h4>Validasi Tambah Data Periode</h4>
                </div>
                <div class="card-body">
                    <form action="{{ route('periode.store') }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('nama_periode') is-invalid @enderror" id="nama_periode"
                                name="nama_periode" placeholder="Masukkan Nama Periode" value="{{ old('nama_periode') }}">
                            @error('nama_periode')
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control @error('status_periode') is-invalid @enderror" id="status_periode" name="status_periode">
                                <option value="aktif" {{ old('status_periode') == 'aktif' ? 'selected' : '' }}>Aktif</option>
                                <option value="nonAktif" {{ old('status_periode') == 'nonAktif' ? 'selected' : '' }}>Non Aktif</option>
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('periode_kepala_sekolah') is-invalid @enderror" id="periode_kepala_sekolah"
                                name="periode_kepala_sekolah" placeholder="Masukkan Nama Kepala Sekolah" value="{{ old('periode_kepala_sekolah') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('periode_nip') is-invalid @enderror" id="periode_nip"
                                name="periode_nip" placeholder="Masukkan NIP Kepala Sekolah" value="{{ old('periode_nip') }}">
                            @error('periode_nip')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
