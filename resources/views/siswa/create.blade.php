                            ...
                            <div class="flex-fill pr-3" style="flex: 1;">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        ...
                                        placeholder="Masukkan Nama Panggilan" value="{{ old('nama_panggilan_siswa') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('jenis_kelamin_siswa') is-invalid @enderror"
                                        ...
                                        <option value="Laki-Laki"
                                            {{ old('jenis_kelamin_siswa') == 'Laki-Laki' ? 'selected' : '' }}>Laki-Laki
                                        </option>
                                        <option value="Perempuan"
                                            {{ old('jenis_kelamin_siswa') == 'Perempuan' ? 'selected' : '' }}>Perempuan
                                        </option>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date"
                                        ...
                                        placeholder="Masukkan Tanggal Lahir" value="{{ old('tanggal_lahir_siswa') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('agama_siswa') is-invalid @enderror" id="agama_siswa"
                                        ...
                                        <option value="Islam" {{ old('agama_siswa') == 'Islam' ? 'selected' : '' }}>Islam
                                        </option>
                                        <option value="Kristen" {{ old('agama_siswa') == 'Kristen' ? 'selected' : '' }}>
                                            Kristen</option>
                                        <option value="Katolik" {{ old('agama_siswa') == 'Katolik' ? 'selected' : '' }}>
                                            Katolik</option>
                                        <option value="Budha" {{ old('agama_siswa') == 'Budha' ? 'selected' : '' }}>Budha
                                        </option>
                                        <option value="Hindu" {{ old('agama_siswa') == 'Hindu' ? 'selected' : '' }}>Hindu
                                        </option>
                                        <option value="Khonghucu"
                                            {{ old('agama_siswa') == 'Khonghucu' ? 'selected' : '' }}>Khonghucu</option>
                                    </select>
                                    @error('agama_siswa')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        ...
                                        placeholder="Masukkan Pekerjaan Ayah" value="{{ old('pekerjaan_ayah_siswa') }}">
                            ...
                            <div class="flex-fill pl-3" style="flex: 1;">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('alamat_siswa') is-invalid @enderror" id="alamat_siswa" name="alamat_siswa"
                                        rows="3" placeholder="Masukkan Alamat">{{ old('alamat_siswa') }}</textarea>
                                    @error('alamat_siswa')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('status_aktif_siswa') is-invalid @enderror"
                                        ...
                                        <option value="Aktif"
                                            {{ old('status_aktif_siswa') == 'Aktif' ? 'selected' : '' }}>Aktif</option>
                                        <option value="Lulus"
                                            {{ old('status_aktif_siswa') == 'Lulus' ? 'selected' : '' }}>Lulus</option>
                                        <option value="Dropout"
                                            {{ old('status_aktif_siswa') == 'Dropout' ? 'selected' : '' }}>Dropout</option>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date"
                                        ...
                                        placeholder="Masukkan Tanggal Kelulusan" value="{{ old('tanggal_kelulusan') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        ...
                                        placeholder="Masukkan Pekerjaan Ibu" value="{{ old('pekerjaan_ibu_siswa') }}">
