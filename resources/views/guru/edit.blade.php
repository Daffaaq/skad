                            ...
                            <div class="flex-fill pr-3" style="flex: 1;">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('nama_pendek_guru', $guru->nama_pendek_guru) }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control @error('tanggal_lahir_guru') is-invalid @enderror"
                                        ...
                                        value="{{ old('tanggal_lahir_guru', $guru->tanggal_lahir_guru) }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('status_perkawinan_guru') is-invalid @enderror"
                                        ...
                                        <option value="Belum Menikah"
                                            {{ old('status_perkawinan_guru', $guru->status_perkawinan_guru) == 'Belum Menikah' ? 'selected' : '' }}>Belum
                                            Menikah</option>
                                        <option value="Menikah"
                                            {{ old('status_perkawinan_guru', $guru->status_perkawinan_guru) == 'Menikah' ? 'selected' : '' }}>Menikah
                                        </option>
                                        <option value="Duda"
                                            {{ old('status_perkawinan_guru', $guru->status_perkawinan_guru) == 'Duda' ? 'selected' : '' }}>Duda</option>
                                        <option value="Janda"
                                            {{ old('status_perkawinan_guru', $guru->status_perkawinan_guru) == 'Janda' ? 'selected' : '' }}>Janda</option>
                                    </select>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <select class="form-control @error('jabatan_guru') is-invalid @enderror"
                                        ...
                                        <option value="Kepala Sekolah"
                                            {{ old('jabatan_guru', $guru->jabatan_guru) == 'Kepala Sekolah' ? 'selected' : '' }}>Kepala Sekolah
                                        </option>
                                        <option value="Wakil Kepala Sekolah"
                                            {{ old('jabatan_guru', $guru->jabatan_guru) == 'Wakil Kepala Sekolah' ? 'selected' : '' }}>Wakil
                                            Kepala Sekolah</option>
                                        <option value="Waka Akademik"
                                            {{ old('jabatan_guru', $guru->jabatan_guru) == 'Waka Akademik' ? 'selected' : '' }}>Waka Akademik
                                        </option>
                                        <option value="Waka Kesiswaan"
                                            {{ old('jabatan_guru', $guru->jabatan_guru) == 'Waka Kesiswaan' ? 'selected' : '' }}>Waka Kesiswaan
                                        </option>
                                        <option value="Waka SarPras"
                                            {{ old('jabatan_guru', $guru->jabatan_guru) == 'Waka SarPras' ? 'selected' : '' }}>Waka SarPras
                                        </option>
                                        <option value="Waka Humas"
                                            {{ old('jabatan_guru', $guru->jabatan_guru) == 'Waka Humas' ? 'selected' : '' }}>Waka Humas</option>
                                    </select>
                                    @error('jabatan_guru')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
