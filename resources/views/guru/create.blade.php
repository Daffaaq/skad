                            ...
                            <div class="flex-fill pr-3" style="flex: 1;">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('status_guru') is-invalid @enderror"
                                        ...
                                        <option value="PNS" {{ old('status_guru') == 'PNS' ? 'selected' : '' }}>PNS</option>
                                        <option value="Honorer" {{ old('status_guru') == 'Honorer' ? 'selected' : '' }}>Honorer</option>
                                    </select>
                                    @error('status_guru')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="flex-fill pl-3" style="flex: 1;">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('alamat_guru') is-invalid @enderror" id="alamat_guru" name="alamat_guru" rows="3"
                                        placeholder="Masukkan Alamat">{{ old('alamat_guru') }}</textarea>
                                    @error('alamat_guru')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('agama_guru') is-invalid @enderror" id="agama_guru" name="agama_guru">
                                        ...
                                        <option value="Islam" {{ old('agama_guru') == 'Islam' ? 'selected' : '' }}>Islam</option>
                                        <option value="Kristen" {{ old('agama_guru') == 'Kristen' ? 'selected' : '' }}>Kristen</option>
                                        <option value="Katolik" {{ old('agama_guru') == 'Katolik' ? 'selected' : '' }}>Katolik</option>
                                        <option value="Budha" {{ old('agama_guru') == 'Budha' ? 'selected' : '' }}>Budha</option>
                                        <option value="Hindu" {{ old('agama_guru') == 'Hindu' ? 'selected' : '' }}>Hindu</option>
                                        <option value="Khonghucu" {{ old('agama_guru') == 'Khonghucu' ? 'selected' : '' }}>Khonghucu</option>
                                    </select>
                                    @error('agama_guru')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control @error('email_guru') is-invalid @enderror" id="email_guru"
                                        name="email_guru" placeholder="Masukkan Email" value="{{ old('email_guru') }}">
                                    @error('email_guru')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('status_aktif_guru') is-invalid @enderror"
                                        ...
                                        <option value="Aktif" {{ old('status_aktif_guru') == 'Aktif' ? 'selected' : '' }}>Aktif</option>
                                        <option value="Pensiun" {{ old('status_aktif_guru') == 'Pensiun' ? 'selected' : '' }}>Pensiun</option>
                                    </select>
